...
const leaderboardData = [
  ...
  { rank: 4, name: "Sofia", xp: 12500, avatar: "https://placehold.co/100x100.png" },
    ...
    <>
      <div className="relative overflow-hidden rounded-xl">
        ...
        <div className="absolute bottom-6 left-6">
            ...
            <p className="text-card-foreground/80 mt-1">See who is on top of the learning game!</p>
        </div>
      </div>
          ...
          <Table>
            ...
            <TableBody>
              {leaderboardData.map((player) => (
                <TableRow key={player.rank} className={player.name === "Sofia" ? "bg-accent" : ""}>
